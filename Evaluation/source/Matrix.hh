...
public:
    ...
    friend Matrix rot90 (const Matrix& a, int k);  ////int k = 1
    ...
    friend Matrix tril (const Matrix& a, int k );  ////int k = 0
    friend Matrix triu (const Matrix& a, int k );  ////int k = 0
    ...
    friend Matrix diag (const Matrix& a, int k );  ////int k = 0
